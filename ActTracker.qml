...
PanelWindow {
    ...
    color: "transparent"
    implicitWidth:  widgetVisible ? 300 : 1
    implicitHeight: widgetVisible ? (collapsed ? 32 : Math.min(420, body.implicitHeight + 16)) : 1
    ...
    // Strip Exile-UI markup to readable text and resolve areaid ids to
    // zone names from the leveling DB.
        ...
        onRunningChanged: {
            if (!running) {
                try {
                    ...
                    // Re-resolve current zone now that data is in
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                ScrollView {
                    ...
                    Layout.fillWidth: true
                    Layout.preferredHeight: Math.min(330, stepsCol.implicitHeight + 6)
                    clip: true
                    ...
                    ColumnLayout {
                        ...
                        Repeater {
                            ...
                            ColumnLayout {
                                ...
                                Rectangle {
                                    Layout.fillWidth: true; height: 1; color: "#1a1a1d"
                                    Layout.topMargin: 2
                                }
                            }
                        }
